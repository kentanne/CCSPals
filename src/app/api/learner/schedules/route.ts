...
// GET - Fetch schedules for learner from external API
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await axios.get(`${EXTERNAL_API_URL}/learners/schedules`, {
      headers: {
    ...
    console.error('Get learner schedules error:', error);
